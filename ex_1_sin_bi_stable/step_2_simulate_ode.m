...
load("models/example_sin_bi_stable.mat")
...
% initialize the values of parameters used in the training (these
% should be the same as in the Python code)
gamma = 1;
beta_1 = 0;

% select a finite time-scale seperation parameter (much less than 1)
time_scale_1 = 0.01;
...
writematrix([t_RNCRN_0,p_RNCRN_0],'data/bi_stable_RNCRN_traj_10.csv')
writematrix([t_RNCRN_1,p_RNCRN_1],'data/bi_stable_RNCRN_traj_7.csv')
writematrix([t_RNCRN_2,p_RNCRN_2],'data/bi_stable_RNCRN_traj_4.csv')
writematrix([t_RNCRN_3,p_RNCRN_3],'data/bi_stable_RNCRN_traj_1.csv')
writematrix([t_RNCRN_4,p_RNCRN_4],'data/bi_stable_RNCRN_traj_14.csv')
writematrix([t_RNCRN_5,p_RNCRN_5],'data/bi_stable_RNCRN_traj_17.csv')

writematrix([t0,p0],'data/bi_stable_non_kinetic_traj_10.csv') 
writematrix([t1,p1],'data/bi_stable_non_kinetic_traj_7.csv') 
writematrix([t2,p2],'data/bi_stable_non_kinetic_traj_4.csv') 
writematrix([t3,p3],'data/bi_stable_non_kinetic_traj_1.csv') 
writematrix([t4,p4],'data/bi_stable_non_kinetic_traj_14.csv') 
writematrix([t5,p5],'data/bi_stable_non_kinetic_traj_17.csv') 
...
writematrix([input_domain', desired_dyn'],'data/bi_stable_non_kinetic_dynam.csv') 
writematrix([input_domain', approx_dyn'],'data/bi_stable_RNCRN_dynam.csv')
