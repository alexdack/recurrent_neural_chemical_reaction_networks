function dpdt = neural_crn_1dvis(t, y, gamma, feedback_offset, time_scale, w1, alphas, b1)
    gamma = double(gamma);
    feedback_offset = double(feedback_offset);
    ...
    feedback_nodes = feedback_offset + y_feedback*(alphas'*y_hidden);
